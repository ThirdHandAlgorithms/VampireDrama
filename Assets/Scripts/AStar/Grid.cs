...
namespace RoyT.AStar
{
    ...
    {       
        ...
        public Grid(int dimX, int dimY, float defaultCost = 1.0f)
        {
            if (defaultCost < 1)
            {
                throw new ArgumentOutOfRangeException(
					"Argument defaultCost with value " + defaultCost.ToString() + " is invalid. The cost of traversing a cell cannot be less than one");
            }
        ...
        public void SetCellCost(Position position, float cost)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(
					"Argument cost with value " + cost.ToString() + " is invalid. The cost of traversing a cell cannot be less than one");
            }
        ...
        private int GetIndex(int x, int y)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(
					"The x-coordinate " + x.ToString() + " is outside of the expected range [0..." + this.DimX.ToString() + "]");
            }

            if (y < 0 || y >= this.DimY)
            {
                throw new ArgumentOutOfRangeException(
					"The y-coordinate " + y.ToString() + " is outside of the expected range [0..." + this.DimY.ToString() + "]");
            }
